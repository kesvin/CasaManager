...
const buttonVariants = {
  ...
  success: "border border-emerald-500/40 bg-emerald-500/15 text-white hover:bg-emerald-500/25 shadow-none",
  danger: "border border-red-700/30 bg-red-700/10 text-red-300 hover:bg-red-700/20 shadow-none",
  statusActive: "border border-emerald-500/40 bg-emerald-500/15 text-white hover:bg-emerald-500/25 shadow-none",
